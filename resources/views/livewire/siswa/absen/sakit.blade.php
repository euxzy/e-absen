...
<form action="{{ route('siswa.absen') }}" method="POST" class="relative z-20" enctype="multipart/form-data">
  ...
  <div
    ...
    <h1 class="text-2xl font-bold text-[#364356]">Sakit</h1>
    ...
    <button type="submit"
      class="w-full rounded-xl bg-[#5667FD] py-2 text-xl font-semibold text-white transition-all duration-300 hover:bg-opacity-70">Sakit</button>
  </div>
</form>
