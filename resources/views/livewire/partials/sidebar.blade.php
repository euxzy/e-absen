...
<div class="fixed inset-y-0 left-10 my-8 w-60 rounded-xl bg-white">
  <div class="py-6 px-4">
    ...
    <ul class="flex flex-col justify-center gap-1 pt-4 text-xs font-semibold text-[#364356]">
      ...
      <li><a href="{{ route('dashboard.walkel.add') }}"
      ...
      <li><a href="{{ route('dashboard.siswa.list') }}"
          class="inline-block w-full rounded-xl px-4 py-3 hover:bg-[#5667FD]/30">Daftar Siswa</a></li>
    </ul>
  </div>
</div>
